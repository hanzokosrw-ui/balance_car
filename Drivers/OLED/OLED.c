...
{
	/*根据BitValue的值，将D0(SCL-PC14)置高电平或者低电平*/
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_14, (GPIO_PinState)BitValue);
}
...
{
	/*根据BitValue的值，将D1(SDA-PB5)置高电平或者低电平*/
...
{
	/*根据BitValue的值，将RES(PB4)置高电平或者低电平*/
...
{
	/*根据BitValue的值，将DC(PB3)置高电平或者低电平*/
...
void OLED_GPIO_Init(void)
{
	...
	/*将D0(SCL-PC14)、D1(SDA-PB5)、RES(PB4)、DC(PB3)初始化为推挽输出模式*/
	/*禁用JTAG，保留SWD，释放PB3、PB4为GPIO*/
